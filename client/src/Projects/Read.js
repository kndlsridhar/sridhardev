...
export const Read = () => {
    ...
    const { id } = useParams();
    // useEffect(() => {
    //     axios.get('https://portfolio-zaj5.onrender.com/Projects/' + id)
                        ...
                        <div className='card'>
                            ...
                            <div className='card-body'>
                                ...
                                <div class="row justify-content-center align-items-center g-2">
                                    ...
                                    <div class="col-xl-6"><img src={`https://portfolio-zaj5.onrender.com/${data.img}`} className='img-fluid' width="50px" height="50px" alt='img' /></div>
                                </div>
                                <div class="row justify-content-center align-items-center g-2">
